...
:cp_dados
if /I "%pdl_id%" == "" set pdl_id=srvnumber0167
...
:cp_local1
if not exist "\\%srv_upd%\superimageVirtual\bck\updbp.id" goto erro_cpl1
...
REM - Modulo de Atualizacao do xpto
:cp_local2
if not exist "\\%srv_upd%\superimageVirtual\bck\updxpto.id" goto erro_cpl2
CD\
...
REM - Modulo de Atualizacao do xpto
:cp_local3
if not exist "\\%srv_upd%\superimageVirtual\bck\updxpto.id" goto erro_cpl3
...
REM - Erro na Inicializacao do Script de Atualizacao do xpto
:er_st_scd
echo >er_st_scd.sra
goto sair
