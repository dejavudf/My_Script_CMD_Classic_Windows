...
echo ******** SCRIPT - Instala superimage ********
...
if exist "\\%1\admin$\system32\mysystemupd\mysystem_v391.id" goto ok
if not exist "\\%1\admin$\system32\" goto erro_ac
robocopy "Arquivos" \\%1\admin$\system32\mysystemupd /Z /E /XO /XX /PURGE /R:1 /LOG:logcp_%1.txt
set n_erro=1
