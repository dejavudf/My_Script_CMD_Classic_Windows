...
:tst_inst1
find /I "superimagevirtual" %systemdrive%\boot.ini
if not %errorlevel% == 0 goto erro_inst
...
if not exist "%drvletra%:\ac_superimage.mv" goto erro_inst
