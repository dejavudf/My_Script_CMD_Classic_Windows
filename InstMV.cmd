...
@echo off
REM Arquivo Principal de instalacao da superimagevirtual versao 8.1
Rem apaga arquivos temporarios e de logs
if exist "*.tmp" del *.tmp
if exist "*.mv" del *.mv

Rem Extrai pacote de instalacao da superimage virtual
:chk_hash
sha mv.cab>hash_tmp.tmp
find /I "baa67f61a0d9c64c8c5503fdceed5c7fe178c07d" hash_tmp.tmp
...
Rem instala a superimagevirtual na particao 3 do disco 1
:instala
ghost32.exe -clone,mode=pload,src=mvghost.gho:1,dst=1:3 -sure -pmbr -batch
if not %errorlevel% == 0 goto erro_gt
BOOTPART %unit% %systemdrive%\BOOTSECT.W40 "superimageVirtual">bp_%computername%.mv
if not %errorlevel% == 0 goto erro_bp
if exist "%systemdrive%\bootsect.w40" attrib +r +s -a +h %systemdrive%\bootsect.w40
echo >mv_inst.id
goto tstdrv0

REM inicio dos testes da letra do drive que foi instalada a superimagevirtual
:tstdrv0
set drvletra=D
if /I exist "d:\AC_superimage.MV" goto ocultar
goto tstdrv1

:tstdrv1
set drvletra=E
if /I exist "e:\AC_superimage.MV" goto ocultar
goto tstdrv2

:tstdrv2
set drvletra=F
if /I exist "f:\AC_superimage.MV" goto ocultar
goto tstdrv3

:tstdrv3
set drvletra=G
if /I exist "g:\AC_superimage.MV" goto ocultar
goto tstdrv4

:tstdrv4
set drvletra=h
if /I exist "h:\AC_superimage.MV" goto ocultar
goto tstdrv5

:tstdrv5
set drvletra=i
if /I exist "i:\AC_superimage.MV" goto ocultar
goto sair

Rem oculta particao que sera instalada a superimagevirtual
:ocultar
...
REM erro na descompactacao do pacote de instalacao da superimagevirtual
:erro_hash
...
Rem erro na ocultacao da particao onde sera instalada a superimagevirtual
:erro_oc
